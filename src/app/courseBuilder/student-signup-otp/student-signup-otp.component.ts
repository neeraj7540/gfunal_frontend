...
@Component({
  selector: 'app-student-signup-otp',
  templateUrl: './student-signup-otp.component.html',
  styleUrls: ['./student-signup-otp.component.css']
})
export class StudentSignupOtpComponent implements OnInit {

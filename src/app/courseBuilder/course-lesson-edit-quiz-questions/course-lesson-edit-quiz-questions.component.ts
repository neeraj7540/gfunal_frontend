...
@Component({
  selector: 'app-course-lesson-edit-quiz-questions',
  templateUrl: './course-lesson-edit-quiz-questions.component.html',
  styleUrls: ['./course-lesson-edit-quiz-questions.component.css']
})
export class CourseLessonEditQuizQuestionsComponent implements OnInit {
  ...
  ngOnInit() {  
    this.addQuestionParam.Question = this.questionsData.question;
    this.questionID = this.questionsData._id;
    this.correctAnswer = this.questionsData.correctAnswer;

    var d = JSON.parse(this.questionsData.options);
    for(let key in d){
     if(d.hasOwnProperty(key)){
       this.array.push(d[key]);
     }
    }
    //console.log(this.array);
    //console.log("fffffffffffffff",JSON.parse(this.questionsData.options));
  }
